<x-layouts.cmms title="Nueva Certificación" headerTitle="Certificaciones">
    ...
    <div class="p-6 max-w-3xl">
        ...
        <div class="flex items-center gap-2 text-sm text-gray-400 mb-6">
            ...
            <span class="text-[#002046] font-medium">Nueva Certificación</span>
        </div>

        <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
            <h2 class="text-lg font-extrabold text-[#002046] font-headline mb-6">Registrar Certificación</h2>

            <form method="POST" action="{{ route('certifications.store') }}" class="space-y-5">
                @csrf
                ...
                <div>
                    ...
                    <input type="text" id="issuing_body" name="issuing_body" value="{{ old('issuing_body') }}"
                ...
                <div>
                    ...
                    <textarea id="notes" name="notes" rows="3"
                              ...
                              class="w-full text-sm border border-gray-200 rounded-lg px-3 py-2.5 focus:outline-none focus:ring-2 focus:ring-[#002046]/20 focus:border-[#002046] @error('notes') border-red-400 @enderror">{{ old('notes') }}</textarea>
                    @error('notes')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>

<x-layouts.cmms title="Nuevo Plan de Mantenimiento" headerTitle="Nuevo Plan de Mantenimiento">
...
<div class="p-8 max-w-4xl mx-auto">
    ...
    <div class="flex items-center gap-4 mb-8">
        ...
        <div>
            <h2 class="text-2xl font-extrabold text-[#002046] font-headline tracking-tight">Nuevo Plan de Mantenimiento</h2>
            <p class="text-sm text-gray-400 mt-0.5">Completa los campos para crear el plan</p>
        </div>
    </div>
    ...
    <form method="POST" action="{{ route('maintenance-plans.store') }}" class="space-y-6">
        ...
        @include('maintenance-plans.partials.form', ['plan' => null])
